                    ...
                    <div class="row">
                        <div class="col-md-12">
                                <div class="card-header">
                                    <strong class="card-title"><h2>hotel spec..</h2></strong>
                                </div>
                                <br>
                                <div class="table">
                                         ...
                                         if(isset($_GET))
                                           { 
                                               $i=1;
                                                ...
                                                $res = pg_query($connect,"SELECT * FROM hotelspecialization" );
                                                         ...
                                                         while($result=pg_fetch_array($res))
                                                         {
                                                            ?>
                                                                ...
                                                                <td> 
                                                                    <?php 
                                                                        $hotelname= $result[1];
                                                                        $specificname = pg_query($connect,"SELECT * FROM hotelregis where id='$hotelname'" );
                                                                        $diname=pg_fetch_array($specificname);
                                                                        echo $diname[1];
                                                                   ?>
                                                                </td>
                                                                   <?php
