            ...
            <div class="login-content">
                <div class="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="user name" name = "usename">
                        </div>
                        <div class="form-group">
                            <label>Forgot Code</label>
                            <input type="password" class="form-control" placeholder="Forgot Code" name="Forgot Code">
                        </div>
                        <div class="form-group">
   ...
   if($_POST)
     {
      ...
      $res = pg_query($connect,"SELECT * FROM logdemo WHERE users = '$us' AND password = '$ps'");
